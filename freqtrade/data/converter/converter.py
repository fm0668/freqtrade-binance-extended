...
def ohlcv_fill_up_missing_data(dataframe: DataFrame, timeframe: str, pair: str) -> DataFrame:
    ...
    if "close_time" in dataframe.columns:
        ohlcv_dict["close_time"] = "last"
    if "quote_asset_volume" in dataframe.columns:
        ohlcv_dict["quote_asset_volume"] = "sum"
    if "number_of_trades" in dataframe.columns:
        ohlcv_dict["number_of_trades"] = "sum"
    if "taker_buy_base_asset_volume" in dataframe.columns:
        ohlcv_dict["taker_buy_base_asset_volume"] = "sum"
    if "taker_buy_quote_asset_volume" in dataframe.columns:
        ohlcv_dict["taker_buy_quote_asset_volume"] = "sum"
