...
# Custom identifier for Binance extended version
BINANCE_EXTENDED_DATA = True
BINANCE_EXTENDED_VERSION = "binance-extended"  # 使用常量标识扩展版本
...
SUPPORTED_FIAT = [
    ...
    "NZD", "PHP", "PKR", "PLN", "RUB", "UAH", "SEK", "SGD", "THB", "TRY",
    "TWD", "ZAR", "USD", "BTC", "ETH", "XRP", "LTC", "BCH", "BNB", "",
]
