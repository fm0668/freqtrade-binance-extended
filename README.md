...
- Extended Binance K-line data support
- Additional timeframe options for data download
- Customized data handling for Binance exchange

For the original Freqtrade documentation and features, please see below.
